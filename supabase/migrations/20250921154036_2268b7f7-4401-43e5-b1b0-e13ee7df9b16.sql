-- Insert sample data with corrected change_type values (only 'increase' or 'decrease' allowed)
...
-- Project Metrics (only use 'increase' or 'decrease' for change_type)
WITH project_ids AS (
...
CROSS JOIN (VALUES
  ...
  ('Campanha Black Friday', 'Alcance', '2.5M+', 'increase', '', 1),
  ...
  ('Vídeo Institucional', 'Visualizações', '500K+', 'increase', '', 1),
